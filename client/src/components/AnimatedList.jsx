...
const AnimatedList = ({
  ...
  scrollbarTrackClass = '[&::-webkit-scrollbar-track]:bg-[#120F17]',
  scrollbarThumbClass = '[&::-webkit-scrollbar-thumb]:bg-[#222] [&::-webkit-scrollbar-thumb]:rounded-[4px]',
  scrollbarThumbColor = '#222',
  scrollbarTrackColor = '#120F17'
}) => {
    ...
    <div className={cn("relative w-[500px]", className)}>
      <div
        ...
        className={cn(
          ...
          displayScrollbar
            ? `[&::-webkit-scrollbar]:w-[8px] ${scrollbarTrackClass} ${scrollbarThumbClass}`
            : 'scrollbar-hide'
        )}
        ...
        {items.map((item, index) => (
          ...
          >
            {renderItem ? (
              ...
              <div className={cn("p-4 bg-[#111] rounded-lg", selectedIndex === index ? 'bg-[#222]' : '', itemClassName)}>
